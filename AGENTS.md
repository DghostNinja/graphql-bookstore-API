...
### JSON File Editing
- ALWAYS validate JSON files after editing: `python3 -c "import json; json.load(open('filename.json'))"`
- Preserve exact indentation (match 4-space or 2-space to existing file)
- When adding items to arrays, maintain proper commas between items
- Use edit tool with full context to avoid structural mistakes
